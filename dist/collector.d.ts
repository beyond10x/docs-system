import type { CollectedSource, CollectionIndex, DocumentationManifestV3, DocumentationManifestV4, DocumentationManifestV5, SharedComponentName, SourceLock } from './types.js';
 ...
 */
export declare function collectManifestSources(manifest: DocumentationManifestV3 | DocumentationManifestV4 | DocumentationManifestV5, repositoryRoot: string, options?: CollectOptions): Promise<CollectionIndex>;
export declare function buildCollectionIndex(manifest: DocumentationManifestV3 | DocumentationManifestV4 | DocumentationManifestV5, files: CollectedSource[]): CollectionIndex;
