import type { CollectedSource, CollectionIndex, DocumentationManifestV3, SharedComponentName, SourceLock } from './types.js';
 ...
 */
export declare function collectManifestSources(manifest: DocumentationManifestV3, repositoryRoot: string, options?: CollectOptions): Promise<CollectionIndex>;
export declare function buildCollectionIndex(manifest: DocumentationManifestV3, files: CollectedSource[]): CollectionIndex;
